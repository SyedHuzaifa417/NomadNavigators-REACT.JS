    ...
    >
      ...
      <div className=" flex flex-col justify-between flex-grow">
        <div className="flex  items-start gap-6">
          <div>
            <div className="flex-shrink-0 w-4 mt-7 mb-3 text-center text-gray-500 font-bold">
              {index + 1 < 10 ? `0${index + 1}` : index + 1}.
            </div>
            <h2 className="place-title text-2xl font-bold text-gray-800 pt-4">
              {place.name}
            </h2>
            ...
            <p className="place-description text-lg text-gray-600">
              {place.description}
            </p>
          </div>
          <h1 className="mt-7 mr-9 font-extrabold text-xl text-slate-700">
            {`$${place.price}`}
          </h1>
        </div>
        <div className="flex gap-x-72 mt-7">
          <div className="flex gap-9">
            <h2 className="flex-shrink-0 text-center text-gray-500 font-bold">
              Great For:
            </h2>
          ...
          <Link
            to={`${place.id}`}
            className="font-semibold text-lg underline text-gray-600 hover:text-blue-400 mt-2"
          >
            View Details
          </Link>
        </div>
