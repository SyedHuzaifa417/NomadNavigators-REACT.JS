...
const ThemeToggle = ({ className = "" }) => {
  ...
  return (
    <label className={`theme-toggle-button ${className}`}>
      ...
      <style jsx>{`
        ...
        .theme-toggle-button svg #patches,
        ...
        .theme-toggle-button input:checked + svg #container {
          fill: #2b4360;
        }
        .theme-toggle-button input:checked + svg #button {
          transform: translate(28px, 2.333px);
        }
        .theme-toggle-button svg #sun {
          opacity: 1;
        }
        .theme-toggle-button input:checked + svg #sun {
          opacity: 0;
        }
        .theme-toggle-button svg #moon {
          opacity: 0;
        }
        .theme-toggle-button input:checked + svg #moon {
          opacity: 1;
        }
        .theme-toggle-button svg #cloud {
          opacity: 1;
        }
        .theme-toggle-button input:checked + svg #cloud {
          opacity: 0;
        }
        .theme-toggle-button svg #stars {
          opacity: 0;
        }
        .theme-toggle-button input:checked + svg #stars {
          opacity: 1;
        }
      `}</style>
    </label>
